...
<Meta title={"Documentation/Library development"} />
...
_Next up_: [Usage of the library in Angular applications](./?path=/story/documentation-client-side-setup--page#client-side-usage-setup)
